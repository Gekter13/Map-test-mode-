...
(function (DC) {
    ...
    var Client = (function () {
        ...
        Client.prototype.nowAsDCTime = function () {
        ...
        Client.prototype.onGotTimestamp = function (status, response) {
            ...
            if (status !== 200) {
                ...
                This.ServerTimeStampOffset = timestamp - This.nowAsDCTime();
        ...
        Client.prototype.getTimestamp = function () {
            return this.nowAsDCTime() + this.ServerTimeStampOffset;
        };
        ...
        //проверку на логин как в логин пейдж
    //   var logg = localStorage.getItem("Login");
   // this.logIn("http://dc.tdc.org.ua", "DC", logg, null, onlogin);
 ...
 var dc = new DC.Client(); 


/*
function GetListName() {
var client = 52;
		var s = JSON.stringify({"Client":client});
		dc.post('TruckingSystem/GetUnits', s, function(HTTPstatus, response, passedOptions) 
                {
		if (HTTPstatus === 200) {
			...
			var s = JSON.stringify({"UnitIDArr":TrackerIDs});
			dc.post('TruckingSystem/GetUnitsLocation', s, function(HTTPstatus, response, passedOptions){
				if (HTTPstatus === 200) {
                ...
                //   for (var i=0; i<res.length; i++){ 
                      // var name = obj[i].ID;
                    //    var Latitude = res[i].Lat;
                    //   var Longitude = res[i].Lon;
                      // alert('ghg');
                   //  document.write("<p>"+'Lat'+ Latitude + ' ' + 'Lon' +  Longitude + " " + name +"</p>");
